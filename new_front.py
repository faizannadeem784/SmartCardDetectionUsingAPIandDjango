...
def perform_ocr2(image_array, language='en'):
    try:
        ...
        converted_list = convert_date_format_list(filtered_data)
        return converted_list, number
...
def OCR_function(image_path, language, box):
    ...
    new_filtered_data1 = {'Name': filtered_data1[0], 'Guardian Name': filtered_data1[1]}
